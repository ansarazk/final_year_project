//Javascript code for fetching humidity and plotting it as a line chart
...
var svg2 = d3.select("body div#hum").append("svg")
...
.on("mouseover", function(d) {		
  div.transition()		
      .duration(200)		
      .style("opacity", 1000);		
  div.html("<b>Humidity</b>:" +d.Imports + "<br/>" +"<b>Time</b>:"+d.time)	
